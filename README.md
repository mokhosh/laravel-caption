...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-xml2srt.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-xml2srt)
...
```bash
php artisan vendor:publish --tag="laravel-xml2srt-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-xml2srt-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-xml2srt-views"
```

## Usage

```php
$laravelXmlToSrt = new Mokhosh\LaravelXmlToSrt();
echo $laravelXmlToSrt->echoPhrase('Hello, Mokhosh!');
```
